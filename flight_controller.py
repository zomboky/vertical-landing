...
class RocketParams:
    ...
    def __init__(self):
        ...
        self.kp_vz = 3500.0           # (N per m/s)
        self.kd_vz = 1200.0           # damping sur d(vz) approx
        self.thrust_rate = 80000.0    # N/s max de variation
...
class FlightComputer:
    ...
    def _compute_suicide_burn(self, z, vz, dt):
        """
        - calc une altitude d'ignition
        - suit une consigne vz(z) plus progressive
        - limite la vitesse de variation du thrust
        """
        g = self.cfg.g
        m = self.current_mass
    ...
    def _compute_pip_guidance(self, pos, vel, z, vz):
        ...
        if z < 20.0:
            ...
            # acc lat souhaitée -> inclinaison (petits angles)
        ...
        # --- Mid/High altitude: vitesse + PIP ---
        # 1) Guidance vitesse (ramener vers centre)
        ...
        # 3) Plus on descend, plus on privilégie la vitesse
    ...
    def _compute_attitude_control(self, target_pitch, target_roll, euler, ang_vel):
        ...
        # PD optimisé par Genetic Algorithm
